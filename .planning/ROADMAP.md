...
## Phase 1.5: Optional card artwork enhancement

Goal: Improve the visual card preview without changing generation or 3D geometry scope.

- Task 1.5.1: Consider a `Molecule2DPreview` component using RDKit.js/WebAssembly to render a 2D SVG from SMILES
- Task 1.5.2: Keep the SMILES-derived SVG as frontend artwork only; MolBlock remains the source of generated 3D geometry
- Task 1.5.3: Leave Python `generate_demo.py` as the generation/runtime integration path
...
- Task 2.3: Integrate 3Dmol.js rendering using serialized MolBlock data
- Task 2.4: Ensure state and UI behave with multiple conformers
...
- Task 3.4: Create phase plan for FastAPI, storage, and search
